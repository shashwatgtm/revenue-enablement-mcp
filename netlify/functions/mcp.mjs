  ...
  if (req.method !== "POST") {
    return new Response(
      JSON.stringify({
        ...
        error: {
          code: -32000,
          message: "Method not allowed. This MCP endpoint accepts POST requests only (Streamable HTTP, stateless). Setup instructions: https://revenue-enablement-mcp.netlify.app/",
        },
        id: null,
      }),
